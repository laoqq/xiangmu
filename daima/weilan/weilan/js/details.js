 ...
 * @LastEditTime: 2019-08-30 20:53:58
...
(function () {
    ...
    $("#J_bookTab").on("click", "li", function () {
        ...
        $(this).children().addClass('a_active');
        $(this).siblings().children().removeClass('a_active')
    ...
    $("#book_info").on("mousemove", ".book-cover", function (event) {
        ...
        let left = event.pageX - $(".book-info").offset().left - $(".reimg").width() / 2;
        let top = event.pageY - $(".book-info").offset().top - $(".reimg").height() / 2;
    ...
    $("#book_info").on("change", "#J_buyNumField", function () {
        ...
        if ($("#J_buyNumField").val() >= 28) {
            ...
            $('#J_bookDetailPopup').css('display', 'block').children().find('#J_lowStockTip').css('display', 'block').siblings().css("display", 'none');
        }
